...
import com.materials.client.widgets.model.content.flex.owner.PrettyOwnerPanel;
import com.materials.client.widgets.model.content.flex.owner.PrettyOwnerView;
import com.materials.client.widgets.question.QuestionReponsePanel;
...
public class AnnonceDetails extends MaterialPanel implements AnnonceDetailsView {

	private static AnnonceDetailsUiBinder uiBinder = GWT.create(AnnonceDetailsUiBinder.class);

	interface AnnonceDetailsUiBinder extends UiBinder<MaterialPanel, AnnonceDetails> {
	}
	...
	private PrettyOwnerPanel ownerPanel;
	...
	@UiField
	MaterialTextBox creationUi, categorieUi, nummerUi, viewsUi, quartierUi, localiteUi, villeUi, provinceUi;
	...
	public void setContentSO(ContentSO contentSO) {
		...
		creationUi.setValue(ttipFormat.format(creation));
		...
		localiteUi.setValue(contentSO.getLocalite());
		villeUi.setValue(contentSO.getVille(), true);
		provinceUi.setValue(contentSO.getProvince(), true);
		...
		ownerPanel = new PrettyOwnerPanel();
	...
	@Override
	public PrettyOwnerView getPrettyOwnerView() {
		return ownerPanel;
	}
