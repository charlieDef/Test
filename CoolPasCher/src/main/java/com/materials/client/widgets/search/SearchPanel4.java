...
public class SearchPanel4 extends Composite implements SearchPanel4View {

	private static SearchPanelUiBinder uiBinder = GWT.create(SearchPanelUiBinder.class);

	interface SearchPanelUiBinder extends UiBinder<MaterialCard, SearchPanel4> {
	}
	...
	public SearchPanel4() {
		...
		buttonCreation.setMarginLeft(-20);
