...
public class PrettyOwnerPanel2 extends Composite implements PrettyOwnerView2 {

	private static OwnerPanelUiBinder uiBinder = GWT.create(OwnerPanelUiBinder.class);

	interface OwnerPanelUiBinder extends UiBinder<Widget, PrettyOwnerPanel2> {
	}
	...
	public void setOwnerInfo(Map<String, String> map) {
		...
		imageUi.setUrl("img/info.jpg");
		labelBigUi.setValue("Plus d'infos sur l'article?");
		labelSmallUi.setValue("Laisser un message");
		...
		annonceurUi.setValue("Cool & pas cher");
