 ...
 *
 */
public class MDFormPanel extends Composite {
	...
	interface MDFormPanelUiBinder extends UiBinder<MaterialCard, MDFormPanel> {
	}
	...
	public MDFormPanel() {
		...
		buttonbar = new FloatingButtonBar();
		buttonbar.setButtonBarEditHandler(new BBarHandler());
	}
	...
	public void setButtonbar(FloatingButtonBar buttonbar) {
